const translations = {
  he: {
    ...
    save: "שמירה",
    delete: "הסר",
    confirm_delete_lecture: "האם אתה בטוח שברצונך למחוק את ההרצאה '{title}'? פעולה זו תמחק גם את כל ההצבעות!",
    lecture_deleted_success: "ההרצאה נמחקה בהצלחה",
    edit: "עריכה",
  ...
  en: {
    ...
    manage_questions_desc: "These questions will appear in all lectures. Changes here will affect all existing lectures.",
    save_questions: "Save Questions",
    questions_saved_success: "Questions saved successfully and updated in all lectures",
    ...
    save: "Save",
    delete: "Remove",
    confirm_delete_lecture: "Are you sure you want to delete the lecture '{title}'? This will also delete all votes!",
